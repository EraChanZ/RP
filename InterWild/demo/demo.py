...
# prepare save paths
input_img_path = 'C:/Users/vladi/RP/ourData2/Data/Dataset/IR images'
...
img_path_list = glob(osp.join(input_img_path, '*.jpg'))
print(img_path_list)
...
for img_path in tqdm(img_path_list):
    ...
    img = transform(img.astype(np.flobb2img_transt32))/255
    img = img.cuda()[None,:,:,:]
    ...
    # save 2D skeleton
    cv2.imwrite(f"renders/img_IR_{i}.jpg", vis_skeleton)
    print("saved ", f"renders/img_{i}.jpg")
